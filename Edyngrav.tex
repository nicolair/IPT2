...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{./Edyngrav_1.fig.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=9cm]{./Edyngrav_2.fig.pdf}
  % Edyngrav_1.pdf: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=
...
\begin{figure}[h]
  \centering
  \includegraphics[width=10cm]{./Edyngrav_3.fig.pdf}
  \includegraphics[width=10cm]{./Edyngrav_4.fig.pdf}
\end{figure}
