...
\begin{figure}
 \centering
 \includegraphics[width=6cm]{Creecriture_1.fig.pdf}
...
\begin{figure}
   ...
   \begin{subfigure}[b]{6cm}
     \includegraphics[width=6cm]{Creecriture_2.fig.pdf}
     \caption{"a(la)a(ra)(a)" 5 itér.}
     \label{fig:Creecriture_2}
    \end{subfigure}
  \begin{subfigure}[b]{6cm}
    \includegraphics[width=6cm]{Creecriture_3.fig.pdf}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{4cm}
    \includegraphics[width=4cm]{Creecriture_4.fig.pdf}
    \caption{Exple 1: 7 itér.}
    \label{fig:Creecriture_4}
  \end{subfigure}
  \begin{subfigure}[b]{4cm}
    \includegraphics[width=4cm]{Creecriture_5.fig.pdf}
    \caption{Exple 2: 7 itér.}
    \label{fig:Creecriture_5}
  \end{subfigure}
  \begin{subfigure}[b]{4cm}
    \includegraphics[width=4cm]{Creecriture_6.fig.pdf}
