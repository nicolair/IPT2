...
%\lhead{Cours IPT}
\chead{Introduction à la complexité algorithmique}
\begin{document}
...
On mesure la rapidité d'un processeur au nombre d'instructions qu'il peut exécuter par seconde. \index{flops}L'unité est le \emph{flops} (floatting operations per second).\newline
