...
plt.savefig('Edyngrav_3.pdf')
plt.clf()

plt.plot(X0,Y0,color='red')
plt.plot(X1,Y1,color='darkgreen')
plt.title(r'$(X0,Y0)\;, \;(X1,Y1)$')
plt.savefig('Edyngrav_4.pdf')
plt.clf()
...
"""    
print((norme2([1,1,1]))**2)

print(smul(3,[1,2,3]))
print(vsom([1,2,3],[4,5,6]))

ELy, ELz = euler(f,3.,6.,0.03,100)
plt.plot(ELy,ELz,color='darkgreen',linestyle='solid',marker='o')
plt.savefig('Edyngrav_1.pdf')
plt.clf()

VLy, VLz = verlet(f,3.,6.,0.03,100)
plt.plot(VLy,VLz,color='darkgreen',linestyle='solid',marker='o')
plt.savefig('Edyngrav_2.pdf')
