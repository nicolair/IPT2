...
--
-- Client :  localhost
-- Généré le :  Dim 21 Mai 2017 à 19:20
...
CREATE TABLE `chambre` (
  `code_service` char(3) NOT NULL DEFAULT '',
  `no_chambre` decimal(3,0) NOT NULL DEFAULT '0',
...
--
ALTER TABLE `chambre`
  ADD PRIMARY KEY (`code_service`,`no_chambre`),
...
ALTER TABLE `employe`
  ADD PRIMARY KEY (`numero`),
  ADD UNIQUE KEY `nom` (`nom`,`prenom`,`tel`);
...
ALTER TABLE `hospitalisation`
  ...
  ADD UNIQUE KEY `code_service` (`code_service`,`no_chambre`,`lit`);
