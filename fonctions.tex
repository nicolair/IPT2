...
La \emph{portée d'un nom}\index{portée d'un nom} est la zone de code dans laquelle il est significatif c'est àdire qu'il désigne un objet. Le même nom peut être utilisé plusieurs fois pour désigner des objets différents dans la mesure où les portées ne se mélangent pas.\newline
